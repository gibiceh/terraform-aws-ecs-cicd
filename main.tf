#: Locals ::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
locals {
  s3_artifact_bucket_arn = join("", aws_s3_bucket.artifact_bucket.*.arn) != null ? join("", aws_s3_bucket.artifact_bucket.*.arn) : var.byo_s3_bucket_artifact_arn
  s3_artifact_bucket_id  = join("", aws_s3_bucket.artifact_bucket.*.id) != null ? join("", aws_s3_bucket.artifact_bucket.*.id) : var.byo_s3_bucket_artifact_id
}
